...
//If you do not provide a dependency array (neither empty nor with specific dependencies) in useCallback, the behavior is
//similar to providing an empty dependency array ([]). The callback function is memoized and created only once when the component
//is initially rendered. It doesn't depend on any values from the component's state or props.
